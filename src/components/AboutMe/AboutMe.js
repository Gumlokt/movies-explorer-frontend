        ...
        <article className="person">
          <div className="person__info">
            ...
            <p className="person__biography">
              Я живу в городе Губкинском. Увлекаюсь веб-разработкой. Так
              сложилось, что моим первым скриптовым языком оказался PERL. На нём
              я написал несколько пэт-проектов. Позже переключился на php и
              изучил Laravel. А примерно в 2017 году переключился на JavaScript
              и с тех пор уделяю ему больше внимания.
